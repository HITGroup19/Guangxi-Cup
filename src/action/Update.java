...
public class Update extends HttpServlet {
	...
	{      
		...
		try {
			...
			System.out.print("---");
			stmt.execute("update baoming set one = '"+one+"',two = '"+two+"',three = '"+three+"',four = '"+four+"',five = '"+five+"' where three = '"+three+"'");
			System.out.print("update baoming set one = '"+one+"',two = '"+two+"',three = '"+three+"',four = '"+four+"',five = '"+five+"' where three = '"+three+"'");
